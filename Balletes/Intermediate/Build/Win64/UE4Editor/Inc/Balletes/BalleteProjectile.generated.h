...
struct FVector;
struct FHitResult;
#ifdef BALLETES_BalleteProjectile_generated_h
#error "BalleteProjectile.generated.h already included, missing '#pragma once' in BalleteProjectile.h"
#endif
...
public: \
	DECLARE_CLASS(ABalleteProjectile, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Balletes"), NO_API) \
...
#define Balletes_Source_Balletes_BalleteProjectile_h_14_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ABalleteProjectile); \
DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ABalleteProjectile); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ABalleteProjectile(ABalleteProjectile&&); \
	NO_API ABalleteProjectile(const ABalleteProjectile&); \
public:
...
template<> BALLETES_API UClass* StaticClass<class ABalleteProjectile>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID Balletes_Source_Balletes_BalleteProjectile_h
